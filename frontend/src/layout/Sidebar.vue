...
const menus = {
  ...
  AGENT: [['dashboard','工作台','DataAnalysis'],['profile','个人资料','User'],['cases','我的案件','Briefcase'],['work-items','工作项','List'],['timesheets','工时填报','Timer'],['deadlines','我的时限','Calendar'],['documents','业务文件','FolderOpened'],['risks','风险中心','Warning'],['performance','个人业绩','TrendCharts'],['notifications','消息中心','Bell']],
}
const adminGroups = [
  { key:'overview', label:'工作概览', icon:'DataAnalysis', items:[['dashboard','工作台','Monitor'],['notifications','消息中心','Bell'],['statistics','业务统计','PieChart']] },
  { key:'cases', label:'案件业务', icon:'Briefcase', items:[['case-review','案件审核','DocumentChecked'],['case-assignment','案件分配','Connection'],['cases','全部案件','Files'],['deadlines','时限管理','Calendar'],['workflow-definitions','流程定义','Share'],['deadline-rules','时限规则','Clock'],['business-calendar','工作日历','Sunny']] },
  ...
  { key:'system', label:'系统管理', icon:'Setting', items:[['users','用户管理','UserFilled'],['external-sync','外部同步','Refresh'],['exceptions','执行异常','WarningFilled'],['data-quality','数据质量','DataAnalysis']] },
]
