...
public class DeadlineService {
    ...
    public DeadlineService(V2Store db, CaseAccessServiceImpl access, Input input, BusinessEvents events) {
    ...
    public DeadlineTask save(Long id, Map<String, Object> body) {
        ...
        events.caseEvent(d.getCaseId(), "DEADLINE", "时限任务: " + d.getTaskName()); events.audit("SAVE_DEADLINE", "DEADLINE", d.getId()); return d;
    }
    @Transactional
    public DeadlineTask complete(Long id) {
        ...
        events.audit("COMPLETE_DEADLINE", "DEADLINE", id); return d;
    }
}
