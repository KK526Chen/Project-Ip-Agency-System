...
import com.ipagency.entity.CaseDeadline;
import java.util.Map;
import org.springframework.web.bind.annotation.*;

@RestController @RequestMapping("/api/deadlines")
public class DeadlineController {
    @GetMapping public ApiResponse<PageResult<CaseDeadline>> list(@RequestParam(defaultValue = "1") long pageNum, @RequestParam(defaultValue = "10") long pageSize, @RequestParam(required = false) Long caseId) { return ApiResponse.success(PageResult.empty(pageNum, pageSize)); }
